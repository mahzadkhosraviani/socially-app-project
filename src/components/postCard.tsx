...
export default function PostCard({ post }: { post: Post }) {
  ...
  return (
    <div className="bg-white border border-gray-200 dark:bg-[#0A0A0A] dark:border-[#262626] rounded-2xl px-6 pt-5 md:w-full md:max-w-240 mt-7 relative">
      {isAuthor && (
        <button
          onClick={handleDelete}
          disabled={isDeleting}
          className="absolute top-4 right-4 text-gray-400 hover:text-red-500 transition-colors cursor-pointer disabled:opacity-50"
