...
const ProfileContainer = ({ user }: { user: any }) => {
  ...
  if (!isReady) {
    return (
      <div className=" w-full max-w-138 h-auto  p-4 bg-white dark:bg-[#171717] dark:border-[#262626] dark:border rounded-2xl shadow flex flex-col gap-4 mb-7">
  ...
  return (
    <div className="w-full max-w-138 mx-auto h-auto  p-4 bg-white dark:bg-[#171717] dark:border-[#262626] dark:border rounded-2xl shadow flex flex-col gap-4 mb-7">
